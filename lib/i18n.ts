...
const dictionaries = {
  "zh-TW": {
    appTitle: APP_NAME,
    appSubtitle:
      "用 The Blue Alliance 的賽事資料，快速看出這場比賽誰是爺爺、爸爸、平輩、兒子或孫子。",
    controlsTitle: "賽事分析",
    modelHint:
      "分數會依排名、勝率、近期狀態、平均聯盟得分、賽程強度與獎項/季後賽加權。資料少時會自動更保守。",
    ...
    noMatchesSummary: "目前還沒有已完成比賽，先維持平輩",
    neutralSummary: "目前資料接近平均值",
    lowDataSummary: "資料仍少，分數偏保守",
  ...
  en: {
    ...
    categoryCaptions: {
      grandpa: "Clearly ahead",
      father: "Solid edge",
      peer: "Roughly even",
      son: "Somewhat behind",
      grandson: "Clearly behind",
    } satisfies Record<ScoreCategory, string>,
    eventTypes: {
      regional: "Regional",
      district: "District Event",
